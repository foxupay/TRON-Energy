...
public final class UInt256 implements UInt256Value<UInt256> {
  ...
  public static UInt256 valueOf(long value) {
    Preconditions.checkArgument(value >= 0, "Argument must be positive");
  ...
  public static UInt256 valueOf(BigInteger value) {
    Preconditions.checkArgument(value.signum() >= 0, "Argument must be positive");
    Preconditions.checkArgument(value.bitLength() <= 256, "Argument is too large to represent a UInt256");
