...
import com.fox.energy.common.exception.user.CaptchaException;
import com.fox.energy.common.exception.user.CaptchaExpireException;
import com.fox.energy.common.exception.user.UserNotExistsException;
import com.fox.energy.common.exception.user.UserPasswordNotMatchException;
...
import com.fox.energy.framework.manager.AsyncManager;
import com.fox.energy.framework.manager.factory.AsyncFactory;
import com.fox.energy.framework.security.context.AuthenticationContextHolder;
...
public class SysLoginService
{
    ...
    public void validateCaptcha(String username, String code, String uuid)
    {
        ...
        if (captchaEnabled)
        {
            String verifyKey = CacheConstants.CAPTCHA_CODE_KEY.key() + StringUtils.nvl(uuid, "");
