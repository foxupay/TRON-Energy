...
import com.fox.energy.system.domain.SysCache;
...
//        caches.add(new SysCache(CacheConstants.PWD_ERR_CNT_KEY, "密码错误次数"));
    ...
    public AjaxResult cache() {
        CacheConstants[] values = CacheConstants.values();
        List<SysCache> caches = new ArrayList<>();
        for (CacheConstants value : values) {
            caches.add(new SysCache(value.key(), value.desc()));
        }
